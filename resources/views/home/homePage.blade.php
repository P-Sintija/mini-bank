...
@section('content')
    ...
    <div class="h-screen w-full flex overflow-hidden">
        <main class="flex-1 flex flex-col bg-gray-100 dark:bg-gray-700 transition duration-500
				...
				dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer ">
                    <div class="flex flex-1 items-center justify-center">
                        <div class="rounded-lg  px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center">
                            <div class="f flex flex-row items-center justify-center ont-bold tracking-wider
                        mb-8 w-full text-gray-600 ">
                            ...
                            <form class="text-center" method="POST" action="{{ route('logIn.logIn') }}">
                                ...
                                <div class="py-2">
                                    <button class=" w-full bg-green-700 hover:bg-green-500 text-white
                        ...
                        <span>
                            Don't have an account?
                                ...
                                <a href="{{ route('registrationForm.show') }}" class="font-light text-md
                            text-green-700 underline font-semibold hover:text-green-500">
                                    Create One </a>
                            </div>
                        </div>
                    </div>
