        ...
        <div class="mx-10 my-2">
            ...
            <div
                ...
                <div class=" ">
                    ...
                    <form class="bg-white  px-8 pb-8 mb-4"
                        method="POST" action="{{ route('refreshCode.create',['id' => $id]) }}">
                        @csrf
                        <div class="flex items-center justify-between mt-4">
                            <button id="submit"
                                    class="bg-white border hover:bg-green-500 text-green-700 hover:text-white
